<template>
  <ul :class="containerClass" v-if="!noLiSurround">
    ...
    <li v-if="!(firstPageSelected() && hidePrevNext)" :class="[pageClass, prevClass, firstPageSelected() ? disabledClass : '']">
      <a @click="prevPage()" @keyup.enter="prevPage()" :class="[pageLinkClass, prevLinkClass]" :tabindex="firstPageSelected() ? -1 : 0" v-html="prevText"></a>
    </li>
    ...
    <li v-if="!(lastPageSelected() && hidePrevNext)" :class="[pageClass, nextClass, lastPageSelected() ? disabledClass : '']">
      <a @click="nextPage()" @keyup.enter="nextPage()" :class="[pageLinkClass, nextLinkClass]" :tabindex="lastPageSelected() ? -1 : 0" v-html="nextText"></a>
    </li>
