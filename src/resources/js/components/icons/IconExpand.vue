<template>
    ...
    <svg class="icon-container" :style="{width: size + 'px', height: size + 'px'}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 444.955 444.955" style="enable-background:new 0 0 444.955 444.955;" xml:space="preserve">
        <g>
            <g>
                <g>
                    <g>
                        <path class="icon-expand" d="M443.715,9.821c-1.621-3.877-4.704-6.992-8.581-8.581L429.063,0h-127.13
                        ...
                        <path class="icon-expand" d="M163.553,258.9L31.782,390.702v-88.768c0-8.74-7.119-15.891-15.891-15.891S0,293.193,0,301.934
